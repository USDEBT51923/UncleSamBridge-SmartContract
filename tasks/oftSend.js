...
module.exports = async function (taskArgs, hre) {
    ...
    console.log("owner.address", owner.address,  "remoteChainId", remoteChainId, "toAddress", toAddress, "ethers.constants.AddressZero",
     ethers.constants.AddressZero, fees[0].toString())
    let tx = await (
